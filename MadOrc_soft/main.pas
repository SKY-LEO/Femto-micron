...
uses
  ...
  IdSSLOpenSSL, IdMultipartFormData, System.DateUtils, About_f, System.ImageList;
...
var
  ...
  max_address: uint = 21600;

  max_fon_massive: array[0..21600] of UInt32;
  doze_massive: array[0..21600] of UInt32;
  ...
  max_fon_massive_ready: array[0..21600] of boolean;
  doze_massive_ready: array[0..21600] of boolean;
...
//  if(Length(Unit1.Form1.max_fon.Caption)<4) then
    Unit1.Form1.max_fon.Caption:=   IntToStr(address Div 216)+'%';
...
//    begin
      Unit1.Form1.impulses.Caption:=   IntToStr(address Div 216)+'%';
//    end else
//    begin
