...
#define LANG_DOSE3MONTH "Доза 3 месяца"
#define LANG_DOSE4MONTH "Доза 4 месяца"
#define LANG_DOSE5MONTH "Доза 5 месяцев"
#define LANG_DOSE6MONTH "Доза 6 месяцев"
